 ...
 * @version    CVS: $Id: Merchant.php,v 1.1 2013/06/27 07:50:20 zcai Exp $
 */
...
class Tracking_Merchant
{
	...
	public function fetchOffer($channelId, $offerId)
	{
        ...
        $sql = "SELECT `ProductID`, `MerchantID`, `URL`, `TrackingURL`, `DataSource`, `Position`, `r_CPC`, `r_ExtraCPC`, `r_BusinessType`
                FROM {$mbpTable}
