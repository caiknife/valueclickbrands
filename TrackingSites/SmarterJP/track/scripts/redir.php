 ...
 * @version    CVS: $Id: redir.php,v 1.1 2013/06/27 07:54:18 jjiang Exp $
 */

require_once dirname(dirname(dirname(dirname(__FILE__)))). '/etc/define.php';

//require_once '../library/Tracking/Logger.php';
/**
 * log message
 *
...
function logMessage($message, Tracking_Request_Outgoing $request) {
	$log = array ('remark' => $message, 'requesturi'    => $request->getRequestUri(),
