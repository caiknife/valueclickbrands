...
class MyAcl
{
    ...
    private function _insertRoles(){
        ...
        $roleTable = new RoleTable($this->adapter , null , $resultSetPrototype);
    ...
    private function _insertResources(){
        ...
        $table = new ResourceTable($this->adapter , null , $resultSetPrototype);
    ...
    private function _insertAllows(){
        ...
        $table = new AclTable($this->adapter , null , $resultSetPrototype);
