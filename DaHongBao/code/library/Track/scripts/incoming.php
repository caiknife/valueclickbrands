 ...
 * @version    CVS: $Id: incoming.php,v 1.1 2013/04/15 10:56:36 rock Exp $
 */
...
/* add Identifier to identify traffic come from the new server  */
if ($nStatIsLanding || $nStatIsLandingOldUser) {
    // include_once 'oldincoming.inc.php';
}
