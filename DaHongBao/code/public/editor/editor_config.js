...
(function() {
    ...
    URL = window.UEDITOR_HOME_URL
            || tmp.substr(0, tmp.lastIndexOf("\/") + 1).replace("_examples/", "").replace("website/", "");// 这里你可以配置成ueditor目录在您网站的相对路径或者绝对路径（指以http开头的绝对路径）
    ...
    window.UEDITOR_CONFIG = {
        ...
        // 图片上传配置区
        ,
        imageUrl : "/uploader/imageUp" // 图片上传提交地址
        ,
        ...
        // 图片在线管理配置区
        ,imageManagerUrl : "/uploader/imageManager" // 图片在线管理的处理地址
        ...
        // word转存配置区
        ,
        wordImageUrl : "/uploader/imageUp" // word转存提交地址
        ,
        wordImagePath : "" //
        ...
        ,
        toolbars : [ [ "fullscreen", "source", "undo", "redo", "insertunorderedlist", "insertorderedlist", "unlink",
                "link", "cleardoc", "selectall", "searchreplace", "preview", "pagebreak", "insertimage", "date",
                "time", "wordimage", "anchor", "spechars", "blockquote", "template", "bold", "italic", "underline",
                "strikethrough", "forecolor", "backcolor", "superscript", "subscript", "justifyleft", "justifycenter",
                "justifyright", "justifyjustify", "removeformat", "formatmatch", "autotypeset", "pasteplain",
