...
/* $Id: phplot.php,v 1.1 2013/04/15 10:58:01 rock Exp $ */
...
class PHPlot {
	...
	// added begin
	// by Nature Zhao on July 6th, 2007
	var $is_draw_XAxis = true;			// whether draw X Axis
	var $is_draw_YAxis = true;			// whether draw Y Axis
	var $prefix = "";					// prefix of y value
	// added end
...
/////////////////////////////////////////////
    ...
    function DrawYAxis()
    {
        ...
        if ($this->is_draw_YAxis){ // added by Nature Zhao on July 6th, 2007
	...
	/*
	 * whether draw X Axis or not
	 * added by Nature Zhao on July 6th, 2007
	 */
	function SetDrawXAxis($is_draw_XAxis){
		$this->is_draw_XAxis = (bool)$is_draw_XAxis;
	}
	
	/*
	 * whether draw Y Axis or not
	 * added by Nature Zhao on July 6th, 2007
	 */
	function SetDrawYAxis($is_draw_YAxis){
		$this->is_draw_YAxis = (bool)$is_draw_YAxis;
	}

	/*
	 * set prefix of y label
	 * added by Nature Zhao on July 6th, 2007
	 */	
    ...
    function DrawXAxis()
    {
        ...
        */
        ...
        if ($this->is_draw_XAxis){ // added by Nature Zhao on July 6th, 2007
    ...
    function DrawYTick($which_ylab, $which_ypix)
    {
        ...
        if (($this->y_tick_pos == 'plotright') || ($this->y_tick_pos == 'both') ) {
			if ($this->y_tick_cross > 0 && $this->y_tick_length > 0 ){ // added by Nature Zhao on July 16th, 2007
            ImageLine($this->img, ($this->plot_area[2] + $this->y_tick_length),
                      $which_ypix, $this->plot_area[2] - $this->y_tick_cross,
                      $which_ypix, $this->ndx_tick_color);
			} // added by Nature Zhao on July 16th, 2007
        }
...
//			modified end
    ...
    function DrawYTicks()
    {
        ...
        // added begin
        // by Nature Zhao on July 13th, 2007
        // draw one more grid line and tick 
		$y_end += $delta_y;
		// added end
		
        for (;$y_tmp < $y_end; $y_tmp += $delta_y) {
            $ylab = $this->prefix . $this->FormatLabel('y', $y_tmp);
