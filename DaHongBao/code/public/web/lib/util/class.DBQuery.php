 ...
 * @version    CVS: $Id: class.DBQuery.php,v 1.1 2013/04/15 10:58:02 rock Exp $
...
*/
	...
	/**
	 * 引号过滤
	 * @param string|array 需要过滤的值或数组
	 * @return string|array 
	 */
	public static function arrayFilter($a) {
		if(is_array($a)){
			$b = array();
            foreach($a as $n=>$v){
                $b[$n]= self::arrayFilter($v);
            }
            return $b;
        }else{
