		...
		<div class="middlecontent">
			...
			<div>
				<table border="0" cellspacing="0" cellpadding="0">
					<tr>
					  <td colspan="2" class="txt3E3E42"><div style="width:590px;"><h1>{$couponRow.Descript}</h1></div></td>
					</tr>
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr style="height:25px;">
							...
							<td width="{$widthPercent}%" class="td_main">
								...
								<div style="height:100px"><a href="{$hotCoupon[loop].url}" target="_blank"><img src="{$hotCoupon[loop].image}" width="{$hotCoupon[loop].imageX}" height="{$hotCoupon[loop].imageY}" title="{$hotCoupon[loop].title}"/></a></div>
								<div id="div_name">
