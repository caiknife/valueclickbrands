...
<div id="content">
	...
	<div class="ad adfill">
		...
		<div class="{if !$smarty.foreach.adsBaiduBottom.last}ad_borderB {/if}bg_img_{$smarty.foreach.adsGoogle.iteration+$smarty.foreach.ads.iteration+$smarty.foreach.adsBaiduBottom.iteration}" onmouseout="glb_baidu_cs(this)" onmouseover="return glb_baidu_ss('{$ads.url}', this)">
			<a href="{$ads.url}" target="_blank">
			<span class="ad_title">{$ads.title}</span>
			<span class="ad_text">{$ads.abstract}</span>
			<span class="ad_url">{$ads.site}</span>
	...
	<div class="ad">
		...
		<div class="{if !$smarty.foreach.adsBottom.last}ad_borderB {/if}bg_img_{$smarty.foreach.adsGoogle.iteration+$smarty.foreach.ads.iteration+$smarty.foreach.adsBaiduBottom.iteration+$smarty.foreach.adsBottom.iteration}">
			<p class="ad_title"><a href="{$ads.url}" target="_blank">{$ads.LINE1}</a></p>
			<p class="ad_text">{$ads.LINE2}</p>
			<p class="ad_url"><a href="{$ads.url}" target="_blank">{$ads.SiteUrl}</a> </p>
		</div>
