...
<link href="../css/search_google_allbd.css" rel="stylesheet" type="text/css" media="all" />
...
<div id="content" class="gg_content">
    ...
    <div class="favBg">
      ...
      <div class="favM">
        {foreach item=ads from=$adsResult.googleAds[0]}
          <ul {if $smarty.foreach.adsbaiName.last}style="padding-bottom: 0px;"{/if}>
  ...
  {if $adsResult.baiduAds[0] }
	<div class="topad topad_single topad_single_bd baiduSearch baiduWrapClick">
    <div class="favBg">
      <div class="favTl"><div class="favTr"></div></div>
      <div class="favM">
      {foreach item=ads name=adsbaiName from=$adsResult.baiduAds[0]}
        <ul onMouseOver="return glb_baidu_ss('{$ads.url}', this)" onMouseOut="glb_baidu_cs(this)" {if $smarty.foreach.adsbaiName.last}style="padding-bottom: 0px;"{/if}>
          <li>
            <a target="_blank"  href="{$ads.url}">
              <span class="b_title">{$ads.title}</span>
              <span class="b_text">{$ads.abstract}</span>
              <span class="b_url">{$ads.site}</span>
            </a>
          </li>
        </ul>
      {/foreach}
	...
	<div id="content_right">
      ...
      <div class="bd_title"><img src="/images/favTxtbaidu.gif"></div>
