...
<div id="middle">
	...
	<div class="middle_map">
		<a href="/">首页</a> > <a href="index.html">网站地图</a> > <a href="{$nameurl}.html">{$name}</a>
		<ul>
			<li class="lili">{$pageStr}</li>
			{section name=loop loop=$couponarray}
			<li class="lileft"><a href="{$couponarray[loop].couponUrl}">{$couponarray[loop].Descript}</a></li>
			<li class="liright"></li>
			<li class="liright"><a href="{$couponarray[loop].couponUrl}"><img src="/images/ck_03.gif" border=0></a></li>
			{/section}
		</ul>
		<!--begin footer-->
