...
'updatecache_step1'         =>"当前数据表更新已完成，现在转入下一张数据表继续操作!",
...
'level_del'					=>"不能删除默认组",
'level_credit_error'		=>"<div style=\"text-align:left;margin-left:50px;\"><font color=\"orange\">评分设置错误：</font><br />1. 最大评分点数不能小于每次评分的最大和最小值的绝对值<br />2. 每次评分的最大值不能小于每次评分的最小值!</div>",
...
'hackcenter_del_fail'       =>"插件卸载完成删除以下文件夹失败，请手动删除<br> hack 目录下的 {$id} 目录",
...
'currrate_error'=>"<font color=\"red\">{$db_currencyname}到论坛积分</font> 的转换比例要小于或等于 <font color=\"red\">论坛积分到{$db_currencyname}</font> 的转换比例",
...
'bbs_open'=>'由于数据操作较大，请关闭论坛后，继续操作!',
'table_change'=>"数据转移中,请稍侯...<br />正在处理第 $tstart 到 $end 条帖子!",
'table_same'=>'请选择不同的数据表进行操作!',
'only_numeric'=>'请输入表下标,只允许数字!',
'table_exists'=>'该表名已存在，请输入其他的下表数字!',
'reg_timelimit'=>'会员注册年限设置错误，为了您系统的稳定，设置区间请不要大于 150 或 小于 0!',
'reg_variable'=>'自定义变量设置错误，请用3-8个小写字母组成!',
