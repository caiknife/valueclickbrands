 ...
 * @version    CVS: $Id: Loader.php,v 1.1 2013/04/15 10:58:19 rock Exp $
 */
...
class Mezi_Loader
{
    ...
    {
        if (class_exists($class, FALSE) || interface_exists($class, FALSE) || strpos($class, '_')===false) {
            return;
        }
