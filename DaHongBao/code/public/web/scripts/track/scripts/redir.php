 ...
 * @version    CVS: $Id: redir.php,v 1.1 2013/04/15 10:58:19 rock Exp $
 */

require_once dirname(dirname(dirname(dirname(__FILE__)))). '/etc/const.inc.php';
...
try {
    ...
    if (!empty($_key) && strtolower($asyncType)=='affiliate') {
