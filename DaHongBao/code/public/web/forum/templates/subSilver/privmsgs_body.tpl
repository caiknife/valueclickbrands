...
<form method="post" name="privmsg_list" action="{S_PRIVMSGS_ACTION}">
  <table width="100%" cellspacing="2" cellpadding="2" border="0" align="center">
   <tr> 
     ...
     <td align="left" width="100%">&nbsp;<span class="nav"><a onclick="top.MyClose=false;" href="{U_INDEX}" class="nav">{L_INDEX}</a></span></td>
  ...
  <table border="0" cellpadding="3" cellspacing="1" width="100%" class="forumline">
   ...
   <tr> 
     ...
     <td width="55%" valign="middle" class="{listrow.ROW_CLASS}">{listrow.PRIVMSG_ATTACHMENTS_IMG}<span class="topictitle">&nbsp;<a onclick="top.MyClose=false;" href="{listrow.U_READ}" class="topictitle">{listrow.SUBJECT}</a></span></td>
     <td width="20%" valign="middle" align="center" class="{listrow.ROW_CLASS}"><span class="name">&nbsp;<a onclick="top.MyClose=false;" href="{listrow.U_FROM_USER_PROFILE}" class="name">{listrow.FROM}</a></span></td>
  ...
  <table width="100%" cellspacing="2" border="0" align="center" cellpadding="2">
   <tr> 
     ...
     <td align="right" valign="top" nowrap="nowrap"><b><span class="gensmall"><a onclick="top.MyClose=false;" href="javascript:select_switch(true);" class="gensmall">{L_MARK_ALL}</a> :: <a onclick="top.MyClose=false;" href="javascript:select_switch(false);" class="gensmall">{L_UNMARK_ALL}</a></span></b><br /><span class="nav">{PAGINATION}<br /></span><span class="gensmall">{S_TIMEZONE}</span></td>
   </tr>
  </table>
</form>
