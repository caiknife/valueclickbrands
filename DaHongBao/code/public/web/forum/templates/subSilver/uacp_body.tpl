...
<form method="post" name="attach_list" action="{S_MODE_ACTION}">
  <table width="100%" cellspacing="2" cellpadding="2" border="0" align="center">
	<tr> 
	  ...
	  <table width="100%" cellspacing="2" cellpadding="2" border="0" align="center">
	<tr>
		<td class="nav" align="left"><a class="nav" onclick="top.MyClose=false;" href="{U_INDEX}">{L_INDEX}</a></td>
	</tr>
</table>
		</td>
  ...
  <table width="100%" cellpadding="3" cellspacing="1" border="0" class="forumline">
	...
	<tr> 
	  ...
	  <td class="{attachrow.ROW_CLASS}" align="center"><span class="gen"><a onclick="top.MyClose=false;" href="{attachrow.U_VIEW_ATTACHMENT}" class="gen" target="_blank">{attachrow.FILENAME}</a></span></td>
  ...
  <table width="100%" cellspacing="2" border="0" align="center" cellpadding="2">
	<tr> 
	  <td align="right" valign="top" nowrap="nowrap"><b><span class="gensmall"><a onclick="top.MyClose=false;" href="javascript:select_switch(true);" class="gensmall">{L_MARK_ALL}</a> :: <a onclick="top.MyClose=false;" href="javascript:select_switch(false);" class="gensmall">{L_UNMARK_ALL}</a></span></b></td>
	</tr>
  </table>
