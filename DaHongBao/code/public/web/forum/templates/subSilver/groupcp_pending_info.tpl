...
<table width="100%" cellpadding="4" cellspacing="1" border="0" class="forumline">
	...
	<tr> 
	  ...
	  <td class="{pending_members_row.ROW_CLASS}" align="center"><span class="gen"><a onclick="top.MyClose=false;" href="{pending_members_row.U_VIEWPROFILE}" class="gen">{pending_members_row.USERNAME}</a></span></td>
