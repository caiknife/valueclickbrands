...
<table width="100%" cellspacing="2" cellpadding="2" border="0" align="center">
  <tr> 
   <td align="left"><span class="nav"><a onclick="top.MyClose=false;" href="{U_INDEX}" class="nav">{L_INDEX}</a> -> <a onclick="top.MyClose=false;" href="{U_VIEW_FORUM}" class="nav">{FORUM_NAME}</a></span></td>
  </tr>
</table>
  ...
  <table width="100%" cellpadding="4" cellspacing="1" border="0" class="forumline">
   ...
   <tr> 
     ...
     <td class="row1">&nbsp;<span class="topictitle">{topicrow.TOPIC_ATTACHMENT_IMG}{topicrow.TOPIC_TYPE}<a onclick="top.MyClose=false;" href="{topicrow.U_VIEW_TOPIC}" class="topictitle">{topicrow.TOPIC_TITLE}</a></span></td>
