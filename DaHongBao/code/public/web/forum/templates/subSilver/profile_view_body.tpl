  ...
  <tr> 
   ...
   <td class="row1" rowspan="3" valign="top"><table width="100%" border="0" cellspacing="1" cellpadding="3">
      ...
      <tr> 
        ...
        <td valign="top"><b><span class="gen">{POSTS}</span></b><br /><span class="genmed">[{POST_PERCENT_STATS} / {POST_DAY_STATS}]</span> <br /><span class="genmed"><a onclick="top.MyClose=false;" href="{U_SEARCH_USER}" class="genmed">{L_SEARCH_USER_POSTS}</a></span></td>
      </tr>
      <tr> 
...
<!-- BEGIN switch_upload_limits -->
      <tr> 
         ...
         <td> 
            ...
            <span class="genmed"><a onclick="top.MyClose=false;" href="{U_UACP}" class="genmed">{L_UACP}</a></span></td>
         </td>
      </tr>
