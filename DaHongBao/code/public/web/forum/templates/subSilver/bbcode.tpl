...
<!-- BEGIN url --><a onclick="top.MyClose=false;" href="{URL}" target="_blank" class="postlink">{DESCRIPTION}</a><!-- END url -->

<!-- BEGIN email --><a onclick="top.MyClose=false;" href="mailto:{EMAIL}">{EMAIL}</A><!-- END email -->
