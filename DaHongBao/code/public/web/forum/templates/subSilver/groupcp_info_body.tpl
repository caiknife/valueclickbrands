...
<table width="100%" cellpadding="4" cellspacing="1" border="0" class="forumline">
	...
	<tr> 
	  ...
	  <td class="row1" align="center"><span class="gen"><a onclick="top.MyClose=false;" href="{U_MOD_VIEWPROFILE}" class="gen">{MOD_USERNAME}</a></span></td>
	...
	<tr> 
	  ...
	  <td class="{member_row.ROW_CLASS}" align="center"><span class="gen"><a onclick="top.MyClose=false;" href="{member_row.U_VIEWPROFILE}" class="gen">{member_row.USERNAME}</a></span></td>
